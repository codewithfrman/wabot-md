...
let allowedNumbers = ['19419318284', '6281267452434', '6281254653853'] // Daftar nomor yang diizinkan

let handler = async (m, _2) => {
  let { conn, usedPrefix, noPrefix, args, groupMetadata } = _2
  let userNumber = m.sender.split('@')[0] // Ambil nomor pengguna

  // Cek apakah nomor pengguna ada di daftar allowedNumbers
  if (!allowedNumbers.includes(userNumber)) {
    return conn.reply(m.chat, 'Maaf, kamu tidak diizinkan mengakses fitur ini.', m)
  }
